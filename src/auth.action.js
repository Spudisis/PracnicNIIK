...
export const checkAthenticated = () => async dispatch=>{
...
export const signup =(name,email, phone,password,re_password)=> async dispatch => {
    ...
    alert('Успешное создание пользователя, проверте почту')
    dispatch({
        type: SIGNUP_SUCCESS,
        payload : res.data
    })
...
export const verify =(uid,token) => async dispatch =>{
    ...
    alert('Успешная активация аккаунта')
    dispatch({
...
export const reset_password =(email)=> async dispatch=>{
    ...
    try{
        ...
        alert('Сообщение о сбросе пароля отправленно на почту')
        dispatch({
